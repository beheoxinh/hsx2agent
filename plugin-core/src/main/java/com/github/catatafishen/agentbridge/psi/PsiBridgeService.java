...
public final class PsiBridgeService implements Disposable {
    ...
    public PsiBridgeService(@NotNull Project project) {
        ...
        allTools.addAll(com.github.catatafishen.agentbridge.psi.tools.meta.MetaToolFactory.create(project));
    ...
    private static void refreshChatToolWindowCache(@NotNull Project project, @NotNull PsiBridgeService service) {
        try {
            ...
            com.intellij.openapi.wm.ToolWindow tw = twm.getToolWindow(com.github.catatafishen.agentbridge.ui.ChatToolWindowFactory.ID);
