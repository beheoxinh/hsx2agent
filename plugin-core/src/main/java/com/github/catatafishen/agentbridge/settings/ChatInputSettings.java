...
public final class ChatInputSettings implements PersistentStateComponent<ChatInputSettings.State> {
    ...
    public SidePanelPosition getSidePanelPosition() {
        return myState.sidePanelPosition == null ? SidePanelPosition.TOP : myState.sidePanelPosition;
    }

    public void setSidePanelPosition(@NotNull SidePanelPosition position) {
        myState.sidePanelPosition = position;
    }
