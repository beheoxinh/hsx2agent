...
public final class InFlightMcpToolRegistry {
     ...
     * {@code run_command}, whose worker is parked waiting on a child process.
     * Distinct from {@link #inFlight}, which only tracks tools that block on an externally
     * completed future (e.g. {@code prompt_user}).
     */
