...
public final class MoveFileTool extends FileTool {
    ...
    private String performRefactoringMove(PsiMoveTarget target) {
        ...
        var document = com.intellij.openapi.application.ReadAction.compute(() ->
            com.intellij.openapi.fileEditor.FileDocumentManager.getInstance().getDocument(target.sourceFile())
        );
